                ...
                <div class="row align-items-center">
                    <div class="col-lg-6">
                        <div class="copyright-text">
                            <p>&copy; 2025 <a href="index.html">MultiCart</a>. All Rights Reserved | BD (+880) 1716
                                571811
                            </p>
                        </div>
                    </div>
        ...
        async getCartData() {
            try {
                ...
                if (data.status == 200) {
                    ...
                    this.cartProducts = data.data.data.data;
                }
                else {
                    console.error('No data found');
                }
