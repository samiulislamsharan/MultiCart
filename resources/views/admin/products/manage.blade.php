                                    ...
                                    <div class="row mb-3">
                                        ...
                                        <div class="col-sm-9">
                                            ...
                                            <span id="add_attribute">
                                                <div class="row" id="add_attribute_{{ $count++ }}">
                                                ...
                                                <div class="row mb-3">
                                                    <div class="col-sm-3">
                                                        <button type="button" class="btn btn-primary w-100"
                                                            id="btn_add_attribute_image">
                                                            <i class="bx bx-plus mr-1"></i>
                                                            Add Image
                                                        </button>
                                                    </div>
                                                    <div class="col-sm-9">
                                                        <input required type="file" id="product_attr_image"
                                                            class="form-control" name="product_attr_image[]"
                                                            accept="image/*" multiple />
                                                        <div id="product_attr_image_preview">
                                                        </div>
                                                    </div>
                                                </div>
                                            </span>
