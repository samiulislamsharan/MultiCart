            ...
            <div class="container">
                <div class="main-body">
                    <div class="row">
                                ...
                                <div class="card-body">
                                    ...
                                    <ul class="list-group list-group-flush">
                                        <li
                                            ...
                                            <span class="text-secondary">https://linktr.ee/samiulislamsharan</span>
                                        </li>
                                        <li
                                            class="list-group-item d-flex justify-content-between align-items-center flex-wrap">
                                            <h6 class="mb-0"><svg xmlns="http://www.w3.org/2000/svg" width="24"
                                            ...
                                            <span class="text-secondary">
                                                <a href="https://github.com/{{ auth()->user()->github_link }}"
                                                    target="blank">
                                                    {{ auth()->user()->github_link }}
                                                </a>
                                            </span>
                                        </li>
                                        <li
                                            ...
                                            <span class="text-secondary">
                                                <a href="https://instagram.com/{{ auth()->user()->insta_link }}"
                                                    target="blank">
                                                    {{ auth()->user()->insta_link }}
                                                </a>
                                            </span>
                                        </li>
                                        <li
                                            ...
                                            <span class="text-secondary">
                                                <a href="https://facebook.com/{{ auth()->user()->facebook_link }}"
                                                    target="blank">
                                                    {{ auth()->user()->facebook_link }}
                                                </a>
                                            </span>
                                        </li>
                                    </ul>
                        ...
                        <div class="col-lg-8">
                            <div class="card">
                                <form id="formSubmit" action="{{ url('admin/save-profile') }}"
